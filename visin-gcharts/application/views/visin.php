...
<head>
	...
	<script type="text/javascript">
		...
		rerata['dataStr'] = '<?php echo $rerata;?>';
		rerata['dataArray'] = JSON.parse(rerata['dataStr']);
		...
		google.charts.setOnLoadCallback(function(){
			...
			drawChart(rerata['dataArray'],'stepped','rerata');
			drawChart(barang['dataArray'],'line','barang');
		});
...
<div class="uk-container">
	<div class="uk-child-width-1-2@s" uk-grid uk-height-match="target: > div > .uk-card">
		...
		<div>
			<div class="uk-card uk-card-default uk-card-small uk-card-body" >
				<h3 class="uk-card-title">Pendapatan Rata-Rata perbulan</h3>
				<div id="rerata" style="height:350px;"></div>
			</div>
		</div>
		<div>
			<div class="uk-card uk-card-default uk-card-small uk-card-body" >
				<h3 class="uk-card-title">Rata Rata penjualan per barang</h3>
